import { _ as _sfc_main$8 } from "./SuperentrenadorLayout.6da620da.js";
import { _ as _sfc_main$7 } from "./VIcon.419634c9.js";
import { V as _export_sfc, y as defineComponent, M as useRoute, z as ref, e as computed, N as onBeforeMount, p as resolveComponent, o as openBlock, i as createElementBlock, j as createBaseVNode, q as createVNode, w as withCtx, t as toDisplayString, D as unref, f as createBlock, l as createCommentVNode, Y as withDirectives, al as vModelSelect, F as Fragment, s as renderList, m as createTextVNode, k as normalizeClass, v as withModifiers, ae as pushScopeId, af as popScopeId, O as _sfc_main$2, am as _sfc_main$6, P as useHead } from "./index.e9744070.js";
import { _ as _sfc_main$5 } from "./VAvatar.ed0a34f1.js";
import { _ as _sfc_main$4 } from "./VFlex.3619bfda.js";
import { _ as _sfc_main$3 } from "./VFlexItem.7a4d5ab7.js";
import { G as GET_DATOS_GENERAL_ENTRENADOR, a as GET_DEPORTISTAS_DE_ENTRENADOR } from "./superentrenador.96fece18.js";
...
const _withScopeId = (n) => (pushScopeId("data-v-198f7d81"), n = n(), popScopeId(), n);
...
const _hoisted_14 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("label", { for: "itemsPerPage" }, "Mostrar:", -1));
const _hoisted_15 = ["value"];
const _hoisted_16 = { class: "main-container" };
const _hoisted_17 = { class: "searched-jobs" };
const _hoisted_18 = { class: "job-cards" };
const _hoisted_19 = { class: "tarjeta" };
const _hoisted_20 = { class: "job-card-title is-multiline" };
const _hoisted_21 = { class: "job-card-subtitle" };
const _hoisted_22 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("strong", null, "Descripci\xF3n: ", -1));
const _hoisted_23 = { class: "job-card-subtitle" };
const _hoisted_24 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("strong", null, "Deporte: ", -1));
const _hoisted_25 = { class: "job-card-subtitle" };
const _hoisted_26 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("strong", null, "Objetivos: ", -1));
const _hoisted_27 = { class: "column" };
const _hoisted_28 = { class: "job-card-buttons" };
const _hoisted_29 = /* @__PURE__ */ createTextVNode(" Ver ");
const _hoisted_30 = {
  class: "v-flex flex-pagination pagination is-rounded",
  role: "navigation",
  "aria-label": "pagination"
};
const _hoisted_31 = { class: "pagination-list" };
                  ...
                  withDirectives(createBaseVNode("select", {
                    ...
                    (openBlock(), createElementBlock(Fragment, null, renderList(5, (n) => {
                      return createBaseVNode("option", {
                        key: n,
                        value: n * 3
                      }, toDisplayString(n * 3), 9, _hoisted_15);
                    }), 64))
                  ], 544), [
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(paginaData), (rutina, index) => {
                        return openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode("div", _hoisted_19, [
                            createBaseVNode("div", _hoisted_20, toDisplayString(rutina.nombre_plan), 1),
          ...
          createBaseVNode("ul", _hoisted_31, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(paginasVisibles), (page, index) => {
              return openBlock(), createElementBlock("li", { key: index }, [
                ...
                }, toDisplayString(page), 11, _hoisted_32)) : (openBlock(), createElementBlock("span", _hoisted_33, "\u2026"))
              ]);
            }), 128))
          ]),
          createBaseVNode("a", {
...
var __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-198f7d81"]]);
