import { r as ref, d as database, H as createUserWithEmailAndPassword, a as auth, s as set, I as deleteUser, g as get, c as child, J as signInWithEmailAndPassword, K as getAuth, L as sendPasswordResetEmail } from "./config.28ac5e58.js";
import { d as addPicture } from "./managePictures.f82dee2f.js";
...
const RECUPERARCONTRA = async (email) => {
  const auth2 = getAuth();
  try {
