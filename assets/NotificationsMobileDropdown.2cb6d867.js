...
import { x as defineComponent, o as openBlock, g as createElementBlock, f as renderSlot, j as normalizeClass, C as unref, U as _export_sfc, m as resolveComponent, i as createBaseVNode, P as withKeys, s as withModifiers, k as createCommentVNode, t as toDisplayString, p as createVNode, w as withCtx, F as Fragment, q as renderList, e as createBlock, V as pushScopeId, W as popScopeId, X as useDarkmode, S as defineStore, u as useStorage, Y as useI18n, B as watch, Z as withDirectives, $ as vModelRadio, E as isRef, b as computed, a0 as useRouter, a as useUserSession, l as createTextVNode, N as _sfc_main$c, y as ref$1, a1 as createStaticVNode } from "./index.7277f539.js";
import { r as ref, d as database, f as onChildChanged, h as onChildAdded, g as get, u as update, a as auth } from "./config.28ac5e58.js";
import { _ as _sfc_main$d, u as useDropdown } from "./VDropdown.40b2c764.js";
import { _ as _sfc_main$b, o as onceImageErrored } from "./VAvatar.ea1017a0.js";
...
var ToolbarNotification_vue_vue_type_style_index_0_scoped_true_lang = "";
const _sfc_main$7 = {
  data() {
    return {
      notificaciones: [],
  ...
  methods: {
    setupListeners() {
      ...
      onChildChanged(videosRef, async (snapshot) => {
      ...
      onChildAdded(planesRef, async (snapshot) => {
        ...
        let NotiR = false;
        if (!notiRSnapshot.exists()) {
          await update(ref(database, `planes_gratuitos/${planID}`), { NotiR: false });
          ...
          if (plan.id_entrenador) {
            ...
            if (entrenadorSnapshot.exists()) {
              ...
              if (entrenador.rol === "Entrenador") {
                ...
                console.warn(`Usuario con ID ${plan.id_entrenador} no tiene el rol de Entrenador.`);
                return;
              }
            }
          }
      ...
      onChildAdded(solicitudesRef, async (snapshot) => {
        ...
        let NotiR = false;
        if (!notiRSnapshot.exists()) {
          await update(ref(database, `solicitudes/${solicitudID}`), { NotiR: false });
          notiRSnapshot = await get(notiRRef);
        }
        NotiR = notiRSnapshot.val();
        if (!NotiR) {
...
const _withScopeId = (n) => (pushScopeId("data-v-3c8ac57a"), n = n(), popScopeId(), n);
const _hoisted_1$7 = { class: "toolbar-notifications is-hidden-mobile" };
const _hoisted_2$7 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("i", {
  "aria-hidden": "true",
  class: "iconify",
...
const _hoisted_8$3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "heading-left" }, [
  /* @__PURE__ */ createBaseVNode("h6", { class: "heading-title" }, "Notificaciones")
], -1));
const _hoisted_9$2 = { class: "heading-right" };
const _hoisted_10$2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "notification-link" }, "Mirar todo", -1));
const _hoisted_11$2 = {
...
const _hoisted_15$2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "tipoMensaje" }, [
...
const _hoisted_22$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "noti-pendiente" }, null, -1));
...
var ToolbarNotification = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render], ["__scopeId", "data-v-3c8ac57a"]]);
