import { _ as _sfc_main$3 } from "./VModal.ec061947.js";
import { V as _export_sfc, y as defineComponent, z as ref, A as onMounted, o as openBlock, i as createElementBlock, j as createBaseVNode, v as withModifiers, Y as withDirectives, a1 as vModelText, q as createVNode, w as withCtx, F as Fragment, s as renderList, t as toDisplayString, ar as vModelCheckbox, Z as vModelRadio, ae as pushScopeId, af as popScopeId, m as createTextVNode, O as _sfc_main$2, P as useHead } from "./index.5157bb01.js";
import { u as useNotyf } from "./useNotyf.f331df09.js";
import { e as onValue, r as ref$1, d as database } from "./config.9bf2e6c5.js";
import { L as LISTAR_DOCUMENTOS_REALTIME, E as ELIMINAR_DOCUMENTO_REALTIME, A as ACTUALIZAR_DOCUMENTO_REALTIME, C as CREAR_DOCUMENTO_REALTIME } from "./main.03abd8f7.js";
...
const _withScopeId = (n) => (pushScopeId("data-v-1276472a"), n = n(), popScopeId(), n);
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(planes.value, (plan, index) => {
                return openBlock(), createElementBlock("tr", { key: index }, [
                  ...
                  createBaseVNode("td", null, [
                    createBaseVNode("button", {
                      class: "delete-button",
                      onClick: ($event) => mostrarInfo1(plan.id)
        ...
        createVNode(_component_VModal, {
          ...
          action: withCtx(() => [
            createVNode(_component_VButton, {
              color: "primary",
              raised: "",
              onClick: _cache[16] || (_cache[16] = ($event) => (eliminarPlan(planEliminar.value), confirmOpen.value = false))
            }, {
              default: withCtx(() => [
                _hoisted_33
              ]),
...
var __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1276472a"]]);
const _sfc_main = {
  setup() {
