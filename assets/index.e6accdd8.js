...
import { _ as _sfc_main$2, a as _sfc_main$3 } from "./VOption.c907f089.js";
import { x as defineComponent, O as useHead, y as ref, B as watch, z as onMounted, o as openBlock, g as createElementBlock, i as createBaseVNode, p as createVNode, w as withCtx, Z as withDirectives, a2 as vModelText, k as createCommentVNode, F as Fragment, q as renderList, e as createBlock, l as createTextVNode, t as toDisplayString, N as _sfc_main$1 } from "./index.7277f539.js";
...
const _hoisted_3 = { class: "parametrizacion-container" };
const _hoisted_4 = /* @__PURE__ */ createTextVNode(" Crear parametrizaci\xF3n ");
const _hoisted_5 = {
  key: 0,
  class: "input-container"
};
const _hoisted_6 = /* @__PURE__ */ createTextVNode(" Guardar ");
const _hoisted_7 = /* @__PURE__ */ createBaseVNode("td", null, [
  /* @__PURE__ */ createBaseVNode("h1", null, "Seleccione Tipo de terreno")
], -1);
const _hoisted_8 = {
  key: 0,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    viewWrapper.setPageTitle("Tipos de terreno");
    useHead({
    ...
    const crearParametrizacion = async () => {
      if (!nuevaParametrizacion.value.trim())
        return;
      const nuevaRef = ref$1(
        database,
        `Parametrizaci\xF3n/TiposTerreno/${nuevaParametrizacion.value}`
      );
    ...
    const crearParametro = async () => {
      ...
      const parametroRef = ref$1(
        database,
        `Parametrizaci\xF3n/TiposTerreno/${seleccionParametrizacion.value}/${nuevoParametro.value}`
      );
    ...
    const cargarParametrizaciones = () => {
      const parametrizacionesRef = ref$1(database, "Parametrizaci\xF3n/TiposTerreno/");
    ...
    const cargarEstados = () => {
      ...
      const estadosRef = ref$1(
        database,
        `Parametrizaci\xF3n/TiposTerreno/${seleccionParametrizacion.value}/`
      );
    ...
    const eliminarEstado = async (id) => {
      ...
      const estadoRef = ref$1(
        database,
        `Parametrizaci\xF3n/TiposTerreno/${seleccionParametrizacion.value}/${id}`
      );
    ...
    const guardarEdicion = async () => {
      if (editandoId.value && nuevoNombre.value.trim() && seleccionParametrizacion.value) {
        const estadoRef = ref$1(
          database,
          `Parametrizaci\xF3n/TiposTerreno/${seleccionParametrizacion.value}/${editandoId.value}`
        );
              ...
              createBaseVNode("td", _hoisted_2, [
                createBaseVNode("div", _hoisted_3, [
                  createVNode(_component_VButton, {
                    color: "primary",
                    class: "btn-crear",
                    onClick: _cache[0] || (_cache[0] = ($event) => creandoParametrizacion.value = !creandoParametrizacion.value)
                  }, {
                    default: withCtx(() => [
                      _hoisted_4
                    ]),
                  ...
                  creandoParametrizacion.value ? (openBlock(), createElementBlock("div", _hoisted_5, [
                    withDirectives(createBaseVNode("input", {
                      "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => nuevaParametrizacion.value = $event),
                      class: "input",
                    ...
                    createVNode(_component_VControl, {
                      ...
                      default: withCtx(() => [
                        createVNode(_component_VSelect, {
                          ...
                          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => seleccionParametrizacion.value = $event)
                        }, {
                          default: withCtx(() => [
