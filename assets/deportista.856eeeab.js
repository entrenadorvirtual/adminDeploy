import { r as ref, d as database, g as get, c as child, u as update } from "./config.f3ec4a91.js";
import { b as buildRitmo } from "./general.502a4700.js";
import { O as OBTENER_DOCUMENTO_REALTIME, A as ACTUALIZAR_DOCUMENTO_REALTIME, C as CREAR_DOCUMENTO_REALTIME } from "./main.9958a253.js";
const dbRef = ref(database);
const LISTADEPORTISTA = async () => {
  const dbRef2 = ref(database);
  const deportista = [];
  return get(child(dbRef2, "users/")).then((snapshot) => {
    if (snapshot.exists()) {
...
export { LISTADEPORTISTA as L, getRitmosDeportista as a, getSemicooper as b, getMorfologiaDeportista as c, getDeportes as d, getObjetivos as e, getDatosDeportista as f, getZonasDeportista as g, getVamsRegistradas as h, getZonaRitmos as i, createRegisterSemicooper as j, getVams as k };
