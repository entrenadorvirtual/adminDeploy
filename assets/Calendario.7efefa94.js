...
import { y as defineComponent, a as useUserSession, z as ref, A as onMounted, e as computed, o as openBlock, f as createBlock, w as withCtx, j as createBaseVNode, i as createElementBlock, t as toDisplayString, q as createVNode, s as renderList, m as createTextVNode, D as unref, F as Fragment$1, l as createCommentVNode, Y as _sfc_main$7, aA as _sfc_main$a, aB as createApp, h as h$1, r as reactive, at as withAsyncContext } from "./index.3437b938.js";
import { _ as _sfc_main$b } from "./VModal.9b3adbf3.js";
import { _ as _sfc_main$9 } from "./VBlock.804b4050.js";
import { _ as _sfc_main$8 } from "./VAvatar.ca051eb6.js";
import { G as GET_TIPOS_INTENSIDAD_RUTINAS, T as TIPO_MEDICION_RUTINA, _ as _sfc_main$5, a as _sfc_main$6, C as CREAR_RUTINA_PERSONALIZADA, A as ACTUALIZAR_RUTINA_PERSONALIZADA, E as ELIMINAR_RUTINA_PERSONALIZADA, L as LISTAR_RUTINAS_DEPORTISTA_ENTRENADOR, b as LISTAR_RUTINAS_DEPORTISTA } from "./rutinas.b7d2c94f.js";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./VOption.1954103c.js";
import { _ as __unplugin_components_2 } from "./VControl.c459fb91.js";
import { _ as _sfc_main$2 } from "./VInput.bb7a011d.js";
import { _ as __extends, t as __assign, v as __spreadArray } from "./config.165bca36.js";
...
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("h1", null, "Comentarios", -1);
const _hoisted_11 = { class: "columns" };
const _hoisted_12 = { class: "column is-10" };
const _hoisted_13 = {
  id: "btn-little",
  class: "column is-2"
};
const _hoisted_14 = /* @__PURE__ */ createTextVNode("Comentar");
const _hoisted_15 = {
  key: 0,
  class: "column is-8 is-half"
};
const _hoisted_16 = { class: "card-head" };
const _hoisted_17 = {
  class: "",
...
const _hoisted_19 = { class: "card-head" };
const _hoisted_20 = {
  class: "",
  style: { "word-wrap": "break-word" }
};
...
const _hoisted_24 = /* @__PURE__ */ createTextVNode("Crear Rutina");
const _hoisted_25 = /* @__PURE__ */ createTextVNode("Actualizar Rutina");
const _hoisted_26 = /* @__PURE__ */ createTextVNode("Eliminar Rutina");
const _hoisted_27 = /* @__PURE__ */ createTextVNode("Cancelar");
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["close", "crear-rutina", "actualizar-rutina", "actualizar-comentarios", "eliminar-rutina"],
  setup(__props, { emit: emits }) {
    ...
    onMounted(() => {
      if (props.opcionactual === "ver" || props.opcionactual === "editar") {
        datosRutina.value = __spreadValues({}, props.rutinaanterior);
      } else {
    ...
    const comentariosOrdenados = computed(() => {
      ...
      const order = comentarios.sort((a2, b2) => b2.fecha - a2.fecha).map((comentario) => {
        return __spreadProps(__spreadValues({}, comentario), { fecha: new Date(comentario.fecha).toLocaleString() });
      }).splice(comentariosActuales.value * comentariosPorPaginacion, comentariosPorPaginacion);
      return order;
    });
    const agregarBloque = (bloque) => {
      var _a;
      (_a = datosRutina.value.bloques) == null ? void 0 : _a.push(__spreadValues({}, bloque));
    };
    ...
    const agregarComentario = () => {
      ...
      const comentariosOrdenados2 = datosRutina.value.comentarios.sort((a2, b2) => a2.id - b2.id);
      ...
      datosRutina.value.comentarios.push(__spreadValues({}, nuevoComentarioBloque.value));
      ...
      return openBlock(), createBlock(_component_VModal, {
        ...
        content: withCtx(() => [
          createBaseVNode("div", _hoisted_1$1, [
            createBaseVNode("div", _hoisted_2, [
              __props.opcionactual === "ver" ? (openBlock(), createElementBlock("h2", _hoisted_3, toDisplayString(datosRutina.value.descripcion ? datosRutina.value.descripcion : "Sin descripci\xF3n"), 1)) : (openBlock(), createBlock(_component_VControl, { key: 1 }, {
                default: withCtx(() => [
          ...
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("div", _hoisted_5, [
              __props.opcionactual === "ver" ? (openBlock(), createElementBlock("h2", _hoisted_6, toDisplayString(datosRutina.value.tipo_esfuerzo), 1)) : (openBlock(), createBlock(_component_VControl, { key: 1 }, {
                default: withCtx(() => [
                  createVNode(_component_VSelect, {
                    ...
                    default: withCtx(() => [
                      (openBlock(true), createElementBlock(Fragment$1, null, renderList(unref(tiposIntensidad), (deporte, index) => {
            ...
            createBaseVNode("div", _hoisted_7, [
              __props.opcionactual === "ver" ? (openBlock(), createElementBlock("h2", _hoisted_8, toDisplayString(datosRutina.value.tipo_medicion), 1)) : (openBlock(), createBlock(_component_VControl, { key: 1 }, {
                default: withCtx(() => [
                  createVNode(_component_VSelect, {
          ...
          __props.opcionactual !== "crear" ? (openBlock(), createElementBlock("div", _hoisted_9, [
            _hoisted_10,
                ...
                createVNode(_component_VControl, null, {
                  default: withCtx(() => [
                    createVNode(_component_VInput, {
                      ...
                      "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => nuevoComentarioBloque.value.comentario = $event),
                      class: "coment",
                      type: "text",
                      placeholder: "Descripci\xF3n"
                    }, null, 8, ["modelValue"])
            ...
            (openBlock(true), createElementBlock(Fragment$1, null, renderList(unref(comentariosOrdenados), (comentario, index) => {
              return openBlock(), createElementBlock("div", {
                ...
                comentario.rol === "Entrenador" ? (openBlock(), createElementBlock("div", _hoisted_15, [
            ...
            createBaseVNode("div", _hoisted_21, [
              ...
              createBaseVNode("div", _hoisted_23, [
                comentariosActuales.value > 0 ? (openBlock(), createElementBlock("a", {
                  key: 0,
                  onClick: _cache[4] || (_cache[4] = ($event) => comentariosActuales.value = 0),
                  onKeypress: _cache[5] || (_cache[5] = ($event) => comentariosActuales.value = 0)
        ...
        action: withCtx(() => [
          ...
          props.opcionactual === "editar" ? (openBlock(), createBlock(_component_VButton, {
            ...
            color: "warning",
            raised: "",
            disabled: !(validacionCrearRutina.value || datosRutina.value.descripcion !== props.rutinaanterior.descripcion),
...
var n, l$1, u$1, t, o, r$1, f$1 = {}, e$1 = [], c$1 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function s(n2, l2) {
  for (var u2 in l2)
    n2[u2] = l2[u2];
  return n2;
...
function b$1(n2) {
  (!n2.__d && (n2.__d = true) && t.push(n2) && !g$2.__r++ || o !== l$1.debounceRendering) && ((o = l$1.debounceRendering) || setTimeout)(g$2);
}
function g$2() {
  for (var n2; g$2.__r = t.length; )
    n2 = t.sort(function(n3, l2) {
      ...
      n3.__d && (o2 = (t2 = (l2 = n3).__v).__e, (r2 = l2.__P) && (u2 = [], (i2 = s({}, t2)).__v = t2.__v + 1, j$2(r2, t2, i2, l2.__n, r2.ownerSVGElement !== void 0, t2.__h != null ? [o2] : null, u2, o2 == null ? _(t2) : o2, t2.__h), z(u2, t2), t2.__e != o2 && k$1(t2)));
    });
}
...
function m$1(n2, l2, u2) {
  for (var i2, t2 = n2.__k, o2 = 0; t2 && o2 < t2.length; o2++)
    (i2 = t2[o2]) && (i2.__ = n2, l2 = typeof i2.type == "function" ? m$1(i2, l2, u2) : A$1(u2, i2, i2, t2, i2.__e, l2));
  return l2;
}
function x(n2, l2) {
...
function j$2(n2, u2, i2, t2, o2, r2, f2, e2, c2) {
  ...
  if (u2.constructor !== void 0)
    return null;
  i2.__h != null && (c2 = i2.__h, e2 = u2.__e = i2.__e, u2.__h = null, r2 = [e2]), (a2 = l$1.__b) && a2(u2);
  try {
    n:
      if (typeof H2 == "function") {
        ...
        h2.state = h2.__s, h2.getChildContext != null && (t2 = s(s({}, t2), h2.getChildContext())), v2 || h2.getSnapshotBeforeUpdate == null || (k2 = h2.getSnapshotBeforeUpdate(y2, _2)), $2 = a2 != null && a2.type === p && a2.key == null ? a2.props.children : a2, w$1(n2, Array.isArray($2) ? $2 : [$2], u2, i2, t2, o2, r2, f2, e2, c2), h2.base = u2.__e, u2.__h = null, h2.__h.length && f2.push(h2), b2 && (h2.__E = h2.__ = null), h2.__e = false;
      } else
...
function L$1(l2, u2, i2, t2, o2, r2, e2, c2) {
  ...
  if (d2 === null)
    ...
    if (C$1(l2, p2, y2, o2, c2), v2)
      u2.__k = [];
    else if (k2 = u2.props.children, w$1(l2, Array.isArray(k2) ? k2 : [k2], u2, i2, t2, o2 && d2 !== "foreignObject", r2, e2, r2 ? r2[0] : i2.__k && _(i2, 0), c2), r2 != null)
      for (k2 = r2.length; k2--; )
...
function N(n2, u2, i2) {
  ...
  i2 || n2.__e == null || a$1(n2.__e), n2.__e = n2.__d = void 0;
}
...
function P$1(u2, i2, t2) {
  var o2, r2, e2;
  l$1.__ && l$1.__(u2, i2), r2 = (o2 = typeof t2 == "function") ? null : t2 && t2.__k || i2.__k, e2 = [], j$2(i2, u2 = (!o2 && t2 || i2).__k = h(p, null, [u2]), r2 || f$1, f$1, i2.ownerSVGElement !== void 0, !o2 && t2 ? [t2] : r2 ? null : i2.firstChild ? n.call(i2.childNodes) : null, e2, !o2 && t2 ? t2 : r2 ? r2.__e : i2.firstChild, o2), z(e2, u2);
}
function B(n2, l2) {
...
var r, u, i, c = [], f = [], e = l$1.__b, a = l$1.__r, v = l$1.diffed, l = l$1.__c, m = l$1.unmount;
function b() {
...
l$1.__b = function(n2) {
  ...
  })) : (i2.__h.forEach(j$1), i2.__h.forEach(k), i2.__h = [])), u = r;
}, l$1.diffed = function(t2) {
  v && v(t2);
  var o2 = t2.__c;
  o2 && o2.__H && (o2.__H.__h.length && (c.push(o2) !== 1 && i === l$1.requestAnimationFrame || ((i = l$1.requestAnimationFrame) || function(n2) {
    var t3, r2 = function() {
      clearTimeout(u2), g$1 && cancelAnimationFrame(t3), setTimeout(n2);
    }, u2 = setTimeout(r2, 100);
    g$1 && (t3 = requestAnimationFrame(r2));
...
function buildOptions(suppliedOptions, appContext) {
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, this.slotOptions), suppliedOptions), {
...
const _hoisted_1 = /* @__PURE__ */ createTextVNode("Cerrar");
  ...
  async setup(__props, { emit: emits }) {
    ...
    const listarRutinas = async () => {
      if (props.identrenador) {
        rutinas.value = await LISTAR_RUTINAS_DEPORTISTA_ENTRENADOR(props.iddeportista, props.identrenador);
      } else {
    ...
    const listarRutinasInitial = async () => {
      ...
      (_a = rutinas.value) == null ? void 0 : _a.forEach((rutina) => {
        ...
        const rutinaEv = {
          ...
          start: t2.toISOString().replace(/T.*$/, "")
        };
    ...
    const actualizarComentarios = async (rutina) => {
      await ACTUALIZAR_RUTINA_PERSONALIZADA(rutina.id, rutina);
    };
    ...
    const calendarOptions = reactive({
      ...
      initialEvents: ([__temp, __restore] = withAsyncContext(() => listarRutinasInitial()), __temp = await __temp, __restore(), __temp),
    ...
    return (_ctx, _cache) => {
      const _component_SesionRutinaPersonalizada = _sfc_main$1;
      const _component_VButton = _sfc_main$7;
      return openBlock(), createElementBlock("div", null, [
        createVNode(unref(FullCalendar), { options: unref(calendarOptions) }, null, 8, ["options"]),
        isOpenCrearSesion.value ? (openBlock(), createBlock(_component_SesionRutinaPersonalizada, {
          key: 0,
          opcionactual: opcionactual.value,
          rutinaanterior: rutinaSelect.value,
          "is-open": isOpenCrearSesion.value,
          onClose: _cache[0] || (_cache[0] = ($event) => isOpenCrearSesion.value = false),
          onCrearRutina: crearRutinaPersonalizada,
          onActualizarRutina: actualizarRutinaPersonalizada,
          onActualizarComentarios: actualizarComentarios,
          onEliminarRutina: eliminarRutinaPersonalizada
        }, null, 8, ["opcionactual", "rutinaanterior", "is-open"])) : createCommentVNode("", true),
        createVNode(_component_VButton, {
          raised: "",
