import { y as defineComponent, O as useRoute, a as useUserSession, z as ref, A as onMounted, aD as axios, o as openBlock, i as createElementBlock, j as createBaseVNode, q as createVNode, w as withCtx, t as toDisplayString, m as createTextVNode, a4 as createStaticVNode, a3 as _sfc_main$1 } from "./index.4254dce5.js";
import { j as getEstadoBienvenida } from "./deportista.f81b0247.js";
import { u as updatePlanUnico } from "./epayco.9fceab50.js";
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      data.value = await axios.get(
        " https://secure.epayco.co/validation/v1/reference/" + route.query.ref_payco
      );
