import { _ as _sfc_main$d } from "./VFlex.82603e9e.js";
import { c as useForm, a as __unplugin_components_2, b as _sfc_main$c } from "./VControl.0351758b.js";
import { _ as _sfc_main$b } from "./VFlexItem.7fc46327.js";
import { _ as _sfc_main$a } from "./VTextarea.8fb3c7a4.js";
import { _ as _sfc_main$7, a as _sfc_main$9 } from "./VFlexTable.49c23410.js";
import { _ as _sfc_main$8 } from "./VIconButton.d74a809b.js";
import { y as defineComponent, o as openBlock, i as createElementBlock, Q as withKeys, v as withModifiers, l as createCommentVNode, j as createBaseVNode, g as renderSlot, k as normalizeClass, V as _export_sfc, z as ref, r as reactive, e as computed, C as watch, A as onMounted, p as resolveComponent, q as createVNode, w as withCtx, D as unref, t as toDisplayString, F as Fragment, s as renderList, f as createBlock, m as createTextVNode, G as isRef, ae as pushScopeId, af as popScopeId, O as _sfc_main$6 } from "./index.81c578a3.js";
import { _ as _sfc_main$5 } from "./VInput.c13b1748.js";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./VOption.315f5aab.js";
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-c7297b26"), n = n(), popScopeId(), n);
  ...
  setup(__props, { emit: emits }) {
    ...
    onMounted(() => {
      if (props.opcionactual === "editar" || props.opcionactual === "ver") {
        let valido = true;
        const bloques = Object.values(props.datosrutina.bloques);
                    ...
                    "body-cell": withCtx(({ column, row, index }) => [
                      ...
                      column.key === "duracion_min" ? (openBlock(), createBlock(_component_VFlexTableCell, {
                        ...
                        default: withCtx(() => [
                          ...
                          props.opcionactual === "ver" ? (openBlock(), createElementBlock("label", _hoisted_74$1, toDisplayString(unref(formatearHoraDobleDigito)(row.duracion_min, row.duracion_seg)), 1)) : createCommentVNode("", true)
                        ]),
                        _: 2
                      }, 1024)) : createCommentVNode("", true),
                      ...
                      "body-cell": withCtx(({ column, row, index }) => [
                        ...
                        column.key === "duracion_min" ? (openBlock(), createBlock(_component_VFlexTableCell, {
                          ...
                          default: withCtx(() => [
                            ...
                            props.opcionactual === "ver" ? (openBlock(), createElementBlock("label", _hoisted_101$1, toDisplayString(unref(formatearHoraDobleDigito)(row.duracion_min, row.duracion_seg)), 1)) : createCommentVNode("", true)
                          ]),
                          _: 2
                        }, 1024)) : createCommentVNode("", true),
                        column.key === "intensidad" ? (openBlock(), createBlock(_component_VFlexTableCell, {
                    ...
                    "body-cell": withCtx(({ column, row, index }) => [
                      column.key === "tipo" ? (openBlock(), createBlock(_component_VFlexTableCell, {
                        ...
                        default: withCtx(() => [
                          ...
                          props.opcionactual === "ver" ? (openBlock(), createElementBlock("label", _hoisted_122$1, toDisplayString(row.tipo), 1)) : createCommentVNode("", true)
                        ]),
                        _: 2
                      }, 1024)) : createCommentVNode("", true),
                      column.key === "duracion_min" ? (openBlock(), createBlock(_component_VFlexTableCell, {
                        ...
                        default: withCtx(() => [
                          ...
                          props.opcionactual === "crear" || props.opcionactual === "editar" ? (openBlock(), createElementBlock("label", _hoisted_123$1, " : ")) : createCommentVNode("", true),
                          props.opcionactual === "crear" || props.opcionactual === "editar" ? (openBlock(), createBlock(_component_VControl, { key: 2 }, {
                            default: withCtx(() => [
                              createVNode(_component_VInput, {
                                modelValue: row.duracion_seg,
                          ...
                          props.opcionactual === "ver" ? (openBlock(), createElementBlock("label", _hoisted_124$1, toDisplayString(unref(formatearHoraDobleDigito)(row.duracion_min, row.duracion_seg)), 1)) : createCommentVNode("", true)
                        ]),
                        _: 2
                      }, 1024)) : createCommentVNode("", true),
                      column.key === "intensidad" ? (openBlock(), createBlock(_component_VFlexTableCell, {
...
var __unplugin_components_6 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c7297b26"]]);
...
const _withScopeId = (n) => (pushScopeId("data-v-034af942"), n = n(), popScopeId(), n);
...
const _hoisted_122 = /* @__PURE__ */ createTextVNode(" Total: ");
const _hoisted_123 = /* @__PURE__ */ createTextVNode(" Clic para mostrar subtotales ");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const distanciaTotal = computed(() => {
      ...
      kilometros = toFixedIfNecessary(kilometros, 1);
      kmCalen = toFixedIfNecessary(kmCalen, 1);
      kmCentral = toFixedIfNecessary(kmCentral, 1);
      kmCalma = toFixedIfNecessary(kmCalma, 1);
      return {
        total: kilometros,
        ...
        hayBloques.value ? (openBlock(), createElementBlock("div", _hoisted_119, [
          createBaseVNode("div", _hoisted_120, [
            createBaseVNode("h3", _hoisted_121, [
              ...
              createTextVNode(" " + toDisplayString(unref(distanciaTotal).total) + " Km ", 1),
              mostrarSubTotales.value ? (openBlock(), createElementBlock("label", _hoisted_124, " (Calentamiento: " + toDisplayString(unref(distanciaTotal).calentamiento) + " Km ) (Central: " + toDisplayString(unref(distanciaTotal).central) + " Km) (Calma: " + toDisplayString(unref(distanciaTotal).calma) + " Km) ", 1)) : createCommentVNode("", true)
            ])
          ])
        ])) : createCommentVNode("", true)
      ]);
...
var __unplugin_components_5 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-034af942"]]);
