...
import { _ as _sfc_main$a } from "./ModalOptions.77d0f432.js";
import { _ as _sfc_main$8 } from "./VModal.ba9a13a9.js";
import { a as useUserSession, a0 as defineStore, z as ref, e as computed, y as defineComponent, A as onMounted, o as openBlock, f as createBlock, aE as createSlots, w as withCtx, q as createVNode, j as createBaseVNode, i as createElementBlock, t as toDisplayString, s as renderList, m as createTextVNode, D as unref, F as Fragment, l as createCommentVNode, Z as _sfc_main$7, r as reactive, M as withKeys, v as withModifiers } from "./index.420249be.js";
import { R as REVERT_SEMANA_RUTINA, f as CONVERT_SEMANA_RUTINA, g as CREAR_PLAN_GRATUITO, h as ACTUALIZAR_PLAN_GRATUITO, G as GET_TIPOS_INTENSIDAD_RUTINAS, T as TIPO_MEDICION_RUTINA, _ as _sfc_main$5, a as _sfc_main$6, i as ASIGNAR_RUTINA_DESDE_BRONCE, N as NEW_REVERT_SEMANA_RUTINA } from "./rutinas.94460818.js";
...
import { _ as _sfc_main$9 } from "./VField.20e6a090.js";
...
const usePlanRutina = defineStore("planRutina", () => {
  ...
  function obtenerSesion(semanaindex, diaindex) {
    return __spreadValues({}, semanasRutina.value[semanaindex][diaindex]);
  }
  ...
  setup(__props, { emit: emits }) {
    ...
    onMounted(() => {
      if (props.opcionactual === "ver" || props.opcionactual === "editar") {
        datosRutina.value = storeUsePlanRutina.obtenerSesion(props.semanaindex, props.diaindex);
      } else {
    ...
    const crearRutina = () => {
      emits("crear-rutina", __spreadValues({}, datosRutina.value));
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const crearPlan = handleSubmit(() => {
      planRutinaStore.guardarPlan(__spreadValues({}, plan.value));
    ...
    const actualizarPlan = () => {
      ...
      planRutinaStore.actualizarPlan(__spreadValues({}, plan.value));
      mostrarCofirmarOpciones.value.actualizar = false;
    };
    const inscribirsePlan = async () => {
      if (props.iddeportista && props.plananterior) {
        await ASIGNAR_RUTINA_DESDE_BRONCE(props.iddeportista, __spreadProps(__spreadValues({}, props.plananterior), {
