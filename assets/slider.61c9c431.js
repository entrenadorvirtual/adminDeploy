import { aI as toRefs, z as ref, e as computed, A as onMounted, E as onUnmounted, C as watch, o as openBlock, i as createElementBlock, x as mergeProps } from "./index.5117c21f.js";
function u(t) {
  return -1 !== [null, void 0, false].indexOf(t);
}
function c(t, e) {
  var r = Object.keys(t);
...
function m(t) {
  return m = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t2) {
    return typeof t2;
  } : function(t2) {
...
var v = h(function(t, e) {
  t.exports = function() {
    ...
    function s(t3, r2, n2, i2, s2, l2, u3, c3, p3, f2, d2, h2) {
      ...
      return l2 && (h2 = l2(h2)), !!o(h2) && (false !== t3 && 0 === parseFloat(h2.toFixed(t3)) && (h2 = 0), h2 < 0 && (m2 = true, h2 = Math.abs(h2)), false !== t3 && (h2 = a(h2, t3)), -1 !== (h2 = h2.toString()).indexOf(".") ? (g2 = (v2 = h2.split("."))[0], n2 && (y2 = n2 + v2[1])) : g2 = h2, r2 && (g2 = e2(g2).match(/.{1,3}/g), g2 = e2(g2.join(e2(r2)))), m2 && c3 && (S2 += c3), i2 && (S2 += i2), m2 && p3 && (S2 += p3), S2 += g2, S2 += y2, s2 && (S2 += s2), f2 && (S2 = f2(S2, b2)), S2);
    }
    function l(t3, e3, i2, a2, s2, l2, u3, c3, p3, f2, d2, h2) {
      var m2, v2 = "";
      return d2 && (h2 = d2(h2)), !(!h2 || "string" != typeof h2) && (c3 && r(h2, c3) && (h2 = h2.replace(c3, ""), m2 = true), a2 && r(h2, a2) && (h2 = h2.replace(a2, "")), p3 && r(h2, p3) && (h2 = h2.replace(p3, ""), m2 = true), s2 && n(h2, s2) && (h2 = h2.slice(0, -1 * s2.length)), e3 && (h2 = h2.split(e3).join("")), i2 && (h2 = h2.replace(i2, ".")), m2 && (v2 += "-"), "" !== (v2 = (v2 += h2).replace(/[^0-9\.\-.]/g, "")) && (v2 = Number(v2), u3 && (v2 = u3(v2)), !!o(v2) && v2));
    }
    function u2(e3) {
      var r2, n2, o2, a2 = {};
      for (void 0 === e3.suffix && (e3.suffix = e3.postfix), r2 = 0; r2 < t2.length; r2 += 1)
        if (void 0 === (o2 = e3[n2 = t2[r2]]))
          "negative" !== n2 || a2.negativeBefore ? "mark" === n2 && "." !== a2.thousand ? a2[n2] = "." : a2[n2] = false : a2[n2] = "-";
        else if ("decimals" === n2) {
          if (!(o2 >= 0 && o2 < 8))
            throw new Error(n2);
          a2[n2] = o2;
        } else if ("encoder" === n2 || "decoder" === n2 || "edit" === n2 || "undo" === n2) {
    ...
    function p2(t3) {
      if (!(this instanceof p2))
        return new p2(t3);
      "object" === m(t3) && (t3 = u2(t3), this.to = function(e3) {
        return c2(t3, s, e3);
...
function y(e, n, i) {
  var o = toRefs(e), a = o.format, s = o.step, l = i.value, u2 = i.classList, c2 = computed(function() {
    return a && a.value ? "function" == typeof a.value ? { to: a.value } : v(function(t) {
  ...
  return { tooltipsFormat: computed(function() {
    ...
    var n2 = "rtl" === getComputedStyle(t).direction, i2 = "rtl" === t.noUiSlider.options.direction, o2 = "vertical" === t.noUiSlider.options.orientation, a2 = t.noUiSlider.getTooltips(), s2 = t.noUiSlider.getOrigins();
...
function S(t) {
  return S = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t2) {
    return typeof t2;
  } : function(t2) {
    return t2 && "function" == typeof Symbol && t2.constructor === Symbol && t2 !== Symbol.prototype ? "symbol" : typeof t2;
  }, S(t);
...
var x = d(h(function(t, e) {
  !function(t2) {
    function e2(t3) {
      return r(t3) && "function" == typeof t3.from;
    }
    function r(t3) {
      return "object" === S(t3) && "function" == typeof t3.to;
    }
    function n(t3) {
    ...
    function u2(t3) {
      return "number" == typeof t3 && !isNaN(t3) && isFinite(t3);
    }
    ...
    function g2(t3) {
      var e3 = void 0 !== window.pageXOffset, r2 = "CSS1Compat" === (t3.compatMode || "");
    ...
    var j = function() {
      ...
      return t3.prototype.getDistance = function(t4) {
        ...
        r2 || t4 !== this.xPct[i2 + 1] || i2++, null === e3 && (e3 = []);
        ...
        return (100 === t4 || e3 && t4 === this.xPct[n2 - 1]) && (n2 = Math.max(n2 - 1, 1)), (this.xVal[n2] - this.xVal[n2 - 1]) / r2;
        ...
        var r2;
        if (!u2(r2 = "min" === t4 ? 0 : "max" === t4 ? 100 : parseFloat(t4)) || !u2(e3[0]))
    ...
    function q(t3, e3) {
      if ("object" !== S(e3) || Array.isArray(e3))
        throw new Error("noUiSlider: 'range' is not an object.");
      if (void 0 === e3.min || void 0 === e3.max)
    ...
    function Y(t3, e3) {
      var r2, n2 = [false];
      if ("lower" === e3 ? e3 = [true, false] : "upper" === e3 && (e3 = [false, true]), true === e3 || false === e3) {
    ...
    function $(t3, e3) {
      ...
      0 !== e3 && (t3.margin = t3.spectrum.getDistance(e3));
    }
    function W(t3, e3) {
      if (!u2(e3))
    ...
    function G(t3, e3) {
      ...
      if (Array.isArray(e3) && 2 !== e3.length && !u2(e3[0]) && !u2(e3[1]))
        throw new Error("noUiSlider: 'padding' option must be numeric or array of exactly 2 numbers.");
      if (0 !== e3) {
    ...
    function ot(t3, e3) {
      ...
      "string" == typeof t3.cssPrefix ? (t3.cssClasses = {}, Object.keys(e3).forEach(function(r2) {
    ...
    function st(e3, r2, s2) {
      var u3, d3, S2, w3, P3, E2 = b2(), N2 = x2() && y2(), C2 = e3, O2 = r2.spectrum, k2 = [], V2 = [], A2 = [], M2 = 0, j2 = {}, U2 = e3.ownerDocument, D2 = r2.documentElement || U2.documentElement, T2 = U2.body, z2 = "rtl" === U2.dir || 1 === r2.ort ? 0 : 100;
      function F2(t3, e4) {
      ...
      function H2(t3, e4) {
        ...
        return i2.setAttribute("role", "slider"), i2.setAttribute("aria-orientation", r2.ort ? "vertical" : "horizontal"), 0 === e4 ? h2(i2, r2.cssClasses.handleLower) : e4 === r2.handles - 1 && h2(i2, r2.cssClasses.handleUpper), n2;
      }
      function q2(t3, e4) {
      ...
      function B2(t3) {
        return h2(t3, r2.cssClasses.target), 0 === r2.dir ? h2(t3, r2.cssClasses.ltr) : h2(t3, r2.cssClasses.rtl), 0 === r2.ort ? h2(t3, r2.cssClasses.horizontal) : h2(t3, r2.cssClasses.vertical), h2(t3, "rtl" === getComputedStyle(t3).direction ? r2.cssClasses.textDirectionRtl : r2.cssClasses.textDirectionLtr), F2(t3, r2.cssClasses.base);
      }
      function _2(t3, e4) {
      ...
      function $2() {
        I2(), P3 = d3.map(_2), mt("update" + L.tooltips, function(t3, e4, n2) {
          if (P3 && r2.tooltips && false !== P3[e4]) {
            var i2 = t3[e4];
            true !== r2.tooltips[e4] && (i2 = r2.tooltips[e4].to(n2[e4])), P3[e4].innerHTML = i2;
          }
        });
      }
      function W2() {
      ...
      function K2(e4) {
        ...
        return (n2 = a(n2.slice().sort(function(t3, e5) {
          ...
          for (w4 && (s4 = O2.xNumSteps[a2]), s4 || (s4 = x3 - S3), void 0 === x3 && (x3 = S3), s4 = Math.max(s4, 1e-7), p3 = S3; p3 <= x3; p3 = r3(p3, s4)) {
      ...
      function Q2(e4, n2, i2) {
        ...
        return h2(s3, r2.cssClasses.pips), h2(s3, 0 === r2.ort ? r2.cssClasses.pipsHorizontal : r2.cssClasses.pipsVertical), Object.keys(e4).forEach(function(t3) {
      ...
      function et2() {
        ...
        return 0 === r2.ort ? t3.width || u3[e4] : t3.height || u3[e4];
      }
      function rt2(t3, e4, n2, i2) {
        var o2 = function(o3) {
          var a3 = nt2(o3, i2.pageOffset, i2.target || e4);
          return !!a3 && !(X2() && !i2.doNotReject) && !(v2(C2, r2.cssClasses.tap) && !i2.doNotReject) && !(t3 === E2.start && void 0 !== a3.buttons && a3.buttons > 1) && (!i2.hover || !a3.buttons) && (N2 || a3.preventDefault(), a3.calcPoint = a3.points[r2.ort], void n2(a3, i2));
        }, a2 = [];
      ...
      function nt2(t3, e4, r3) {
        var n2 = 0 === t3.type.indexOf("touch"), i2 = 0 === t3.type.indexOf("mouse"), o2 = 0 === t3.type.indexOf("pointer"), a2 = 0, s3 = 0;
        if (0 === t3.type.indexOf("MSPointer") && (o2 = true), "mousedown" === t3.type && !t3.buttons && !t3.touches)
          return false;
        if (n2) {
          var l2 = function(e5) {
            var n3 = e5.target;
      ...
      function ot2(t3) {
        ...
        return d3.forEach(function(n2, i2) {
          if (!Y2(i2)) {
            ...
            (a2 < e4 || a2 <= e4 && t3 > o2 || 100 === a2 && 100 === e4) && (r3 = i2, e4 = a2);
          }
        }), r3;
      }
      function st2(t3, e4) {
        "mouseout" === t3.type && "HTML" === t3.target.nodeName && null === t3.relatedTarget && ut2(t3, e4);
      }
      function lt2(t3, e4) {
        if (-1 === navigator.appVersion.indexOf("MSIE 9") && 0 === t3.buttons && 0 !== e4.buttonsProperty)
          return ut2(t3, e4);
      ...
      function ut2(t3, e4) {
        ...
        }), 0 === M2 && (m2(C2, r2.cssClasses.drag), Et(), t3.cursor && (T2.style.cursor = "", T2.removeEventListener("selectstart", o))), e4.handleNumbers.forEach(function(t4) {
      ...
      function ct(t3, e4) {
        if (!e4.handleNumbers.some(Y2)) {
          var n2;
          1 === e4.handleNumbers.length && (n2 = d3[e4.handleNumbers[0]].children[0], M2 += 1, h2(n2, r2.cssClasses.active)), t3.stopPropagation();
      ...
      function pt(t3) {
        ...
        false !== n2 && (r2.events.snap || c2(C2, r2.cssClasses.tap, r2.animationDuration), Nt(n2, e4, true, true), Et(), bt("slide", n2, true), bt("update", n2, true), r2.events.snap ? ct(t3, { handleNumbers: [n2] }) : (bt("change", n2, true), bt("set", n2, true)));
      }
      function ft(t3) {
        var e4 = it2(t3.calcPoint), r3 = O2.getStep(e4), n2 = O2.fromStepping(r3);
        Object.keys(j2).forEach(function(t4) {
          "hover" === t4.split(".")[0] && j2[t4].forEach(function(t5) {
            t5.call(zt, n2);
          });
        });
      }
      function dt(t3, e4) {
        ...
        if (t3.preventDefault(), f3 || p3) {
          ...
          if (null === v3)
            return false;
          false === v3 && (v3 = O2.getDefaultStep(V2[e4], p3, r2.keyboardDefaultStep)), v3 *= c3 || u4 ? r2.keyboardPageMultiplier : r2.keyboardMultiplier, v3 = Math.max(v3, 1e-7), v3 *= p3 ? -1 : 1, s3 = k2[e4] + v3;
        } else
      ...
      function ht(t3) {
        t3.fixed || d3.forEach(function(t4, e4) {
          ...
          if (false !== e4 && 0 !== n2 && n2 !== S2.length - 1) {
      ...
      function mt(t3, e4) {
        j2[t3] = j2[t3] || [], j2[t3].push(e4), "update" === t3.split(".")[0] && d3.forEach(function(t4, e5) {
          bt("update", e5);
        });
      }
      function vt(t3) {
      ...
      function yt(t3, e4, n2, i2, o2, a2) {
        var s3;
        return d3.length > 1 && !r2.events.unconstrained && (i2 && e4 > 0 && (s3 = O2.getAbsoluteDistance(t3[e4 - 1], r2.margin, false), n2 = Math.max(n2, s3)), o2 && e4 < d3.length - 1 && (s3 = O2.getAbsoluteDistance(t3[e4 + 1], r2.margin, true), n2 = Math.min(n2, s3))), d3.length > 1 && r2.limit && (i2 && e4 > 0 && (s3 = O2.getAbsoluteDistance(t3[e4 - 1], r2.limit, false), n2 = Math.min(n2, s3)), o2 && e4 < d3.length - 1 && (s3 = O2.getAbsoluteDistance(t3[e4 + 1], r2.limit, true), n2 = Math.max(n2, s3))), r2.padding && (0 === e4 && (s3 = O2.getAbsoluteDistance(0, r2.padding[0], false), n2 = Math.max(n2, s3)), e4 === d3.length - 1 && (s3 = O2.getAbsoluteDistance(100, r2.padding[1], true), n2 = Math.min(n2, s3))), !((n2 = p2(n2 = O2.getStep(n2))) === t3[e4] && !a2) && n2;
      }
      function St(t3, e4) {
        var n2 = r2.ort;
      ...
      function xt(t3, e4, r3, n2, i2) {
        ...
        n2 = n2.slice(), t3 && n2.reverse(), n2.length > 1 ? n2.forEach(function(t4, r4) {
          ...
          false === n3 ? e4 = 0 : (e4 = n3 - o2[t4], o2[t4] = n3);
        }) : s3 = l2 = [true];
        var u4 = false;
      ...
      function Nt(t3, e4, r3, n2, i2) {
        return i2 || (e4 = yt(V2, t3, e4, r3, n2, false)), false !== e4 && (Pt(t3, e4), true);
      }
      function Ct(t3) {
        if (S2[t3]) {
          var e4 = 0, n2 = 100;
          0 !== t3 && (e4 = V2[t3 - 1]), t3 !== S2.length - 1 && (n2 = V2[t3]);
          var i2 = n2 - e4, o2 = "translate(" + St(wt(e4, i2) + "%", "0") + ")", a2 = "scale(" + St(i2 / 100, "1") + ")";
          S2[t3].style[r2.transformRule] = o2 + " " + a2;
        }
      }
      function Ot(t3, e4) {
        return null === t3 || false === t3 || void 0 === t3 ? V2[e4] : ("number" == typeof t3 && (t3 = String(t3)), false !== (t3 = r2.format.from(t3)) && (t3 = O2.toStepping(t3)), false === t3 || isNaN(t3) ? V2[e4] : t3);
      }
      function kt(t3, e4, n2) {
        var i2 = f2(t3), o2 = void 0 === V2[0];
        e4 = void 0 === e4 || e4, r2.animate && !o2 && c2(C2, r2.cssClasses.tap, r2.animationDuration), A2.forEach(function(t4) {
          Nt(t4, Ot(i2[t4], t4), true, false, n2);
        });
        var a2 = 1 === A2.length ? 0 : 1;
        ...
        Et(), A2.forEach(function(t4) {
          bt("update", t4), null !== i2[t4] && e4 && bt("set", t4);
        });
      }
      function Vt(t3) {
        kt(r2.start, t3);
      ...
      function Mt(t3) {
        if (void 0 === t3 && (t3 = false), t3)
          return 1 === k2.length ? k2[0] : k2.slice(0);
        var e4 = k2.map(r2.format.to);
        return 1 === e4.length ? e4[0] : e4;
      }
      function jt() {
      ...
      function Ut(t3) {
        ...
        false !== o2 && i2 + o2 > n2.stepAfter.startValue && (o2 = n2.stepAfter.startValue - i2), a2 = i2 > n2.thisStep.startValue ? n2.thisStep.step : false !== n2.stepBefore.step && i2 - n2.stepBefore.highestStep, 100 === e4 ? o2 = null : 0 === e4 && (a2 = null);
      ...
      function Lt(t3, e4) {
        ...
        o2.forEach(function(e5) {
          void 0 !== t3[e5] && (s2[e5] = t3[e5]);
        });
        var a2 = at(s2);
        o2.forEach(function(e5) {
          void 0 !== t3[e5] && (r2[e5] = a2[e5]);
...
var P = { name: "Slider", emits: ["input", "update:modelValue", "update", "change"], props: { ...{ value: { validator: function(t) {
  return (t2) => "number" == typeof t2 || t2 instanceof Array || null == t2 || false === t2;
  ...
  const l = function(r, n, i) {
    var o = toRefs(r), a2 = o.value, s2 = o.modelValue, l2 = void 0 !== n.expose ? s2 : a2, c3 = ref(l2.value);
    if (u(l2.value))
      throw new Error("Slider v-model must be a Number or Array");
    if (Array.isArray(l2.value) && 0 == l2.value.length)
    ...
    return { classList: computed(function() {
      ...
      }), "always" !== s2.value && (t.target += " ".concat("drag" === s2.value ? t.tooltipDrag : t.tooltipFocus)), "horizontal" === u2.value && (t.tooltip += "bottom" === l2.value ? " ".concat(t.tooltipBottom) : " ".concat(t.tooltipTop)), "vertical" === u2.value && (t.tooltip += "right" === l2.value ? " ".concat(t.tooltipRight) : " ".concat(t.tooltipLeft)), t;
    }) };
