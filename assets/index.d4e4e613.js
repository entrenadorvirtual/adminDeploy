import { _ as _sfc_main$8 } from "./VModal.72068d4c.js";
import { y as defineComponent, o as openBlock, i as createElementBlock, t as toDisplayString, k as normalizeClass, z as ref$1, r as reactive, A as onMounted, e as computed, p as resolveComponent, j as createBaseVNode, q as createVNode, w as withCtx, D as unref, F as Fragment, s as renderList, an as TransitionGroup, Q as withKeys, v as withModifiers, f as createBlock, l as createCommentVNode, m as createTextVNode, O as _sfc_main$7, V as _export_sfc, P as useHead } from "./index.7ac0c9d2.js";
import { _ as _sfc_main$6 } from "./VTextarea.c3d16e44.js";
import { o as onceImageErrored, _ as _sfc_main$5 } from "./VAvatar.df463660.js";
import { _ as _sfc_main$4 } from "./VField.44da70b8.js";
import { a as __unplugin_components_0 } from "./VControl.f6d74c4b.js";
import { _ as _sfc_main$3 } from "./VInput.85dd5294.js";
import { p as preview } from "./managePictures.db7c7df1.js";
import { u as useNotyf } from "./useNotyf.edf649d6.js";
import { a as CREAR_DOCUMENTO_REALTIME2, O as OBTENER_DOCUMENTO_REALTIME, E as ELIMINAR_DOCUMENTO_REALTIME, A as ACTUALIZAR_DOCUMENTO_REALTIME } from "./main.abb91ed8.js";
import { v as ref, w as storage, B as uploadBytes, z as getDownloadURL } from "./config.cf3a8941.js";
import { S as Swal } from "./sweetalert2.all.06d06f4b.js";
  ...
  setup(__props) {
    ...
    const cargarAlianzas = async () => {
      try {
        ...
        notif2.error("No se pudieron cargar las alianzas.");
      }
    };
    onMounted(() => {
      cargarAlianzas();
    ...
    const previewImage = async (event) => {
      ...
      if (prevImagen.accept) {
        ...
        imagen.message = "";
        imagen.dataUrl = null;
        notif2.error("El archivo debe ser JPG o PNG y menor a 2MB.");
      }
    };
    const handleGuardarAlianza = async () => {
      ...
      try {
        ...
        if (imgProfile.picture) {
          notif2.success("Subiendo imagen, por favor espera...");
        ...
        if (editMode.value) {
          ...
          notif2.success(`Alianza "${alianza.nombre}" actualizada exitosamente.`);
        } else {
          await crearAlianza(alianza);
          notif2.success(`Alianza "${alianza.nombre}" creada exitosamente.`);
        }
        cargarAlianzas();
        ...
        notif2.error("Hubo un error al guardar la alianza. Int\xE9ntalo de nuevo.");
      }
    };
    ...
    const handleEliminarAlianza = (alianza2) => {
      Swal.fire({
        ...
        text: "\xA1Esta acci\xF3n no se puede deshacer!",
        icon: "warning",
        ...
        if (result.isConfirmed) {
          ...
          Swal.fire({
            title: "\xA1Eliminado!",
            text: "La alianza ha sido eliminada correctamente.",
            icon: "success",
              ...
              createBaseVNode("div", _hoisted_45, [
                ...
                createBaseVNode("div", _hoisted_56, [
                  ...
                  createBaseVNode("div", _hoisted_61, [
                    createVNode(_component_VField, { label: "Pagina Web" }, {
                      default: withCtx(() => [
                        createVNode(_component_VControl, { class: "input-gray" }, {
                          default: withCtx(() => [
                            createVNode(_component_VInput, {
