import { y as defineComponent, a as useUserSession, z as ref, A as onMounted, e as computed, o as openBlock, f as createBlock, w as withCtx, j as createBaseVNode, i as createElementBlock, t as toDisplayString, q as createVNode, s as renderList, m as createTextVNode, D as unref, F as Fragment$1, l as createCommentVNode, a2 as _sfc_main$7, aE as _sfc_main$a, aF as createApp, h as h$1, r as reactive, aC as withAsyncContext } from "./index.5117c21f.js";
import { _ as _sfc_main$b } from "./VModal.61ebb5be.js";
import { _ as _sfc_main$9 } from "./VBlock.eaea9b4f.js";
import { _ as _sfc_main$8 } from "./VAvatar.87605638.js";
import { G as GET_TIPOS_INTENSIDAD_RUTINAS, T as TIPO_MEDICION_RUTINA, _ as _sfc_main$5, a as _sfc_main$6, C as CREAR_RUTINA_PERSONALIZADA, A as ACTUALIZAR_RUTINA_PERSONALIZADA, E as ELIMINAR_RUTINA_PERSONALIZADA, L as LISTAR_RUTINAS_DEPORTISTA_ENTRENADOR, b as LISTAR_RUTINAS_DEPORTISTA } from "./rutinas.68907f7b.js";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./VOption.f0d0ae2d.js";
import { _ as __unplugin_components_2 } from "./VControl.a2f9c194.js";
import { _ as _sfc_main$2 } from "./VInput.fe703cdc.js";
import { y as __extends, z as __assign, A as __spreadArray } from "./config.fc5b324a.js";
...
function m$1(n2) {
  (!n2.__d && (n2.__d = true) && t.push(n2) && !w$2.__r++ || r$1 !== l$1.debounceRendering) && ((r$1 = l$1.debounceRendering) || o)(w$2);
}
function w$2() {
  var n2, l2, u2, i2, r2, o2, e2, c2;
  for (t.sort(f$1); n2 = t.shift(); )
    n2.__d && (l2 = t.length, i2 = void 0, r2 = void 0, e2 = (o2 = (u2 = n2).__v).__e, (c2 = u2.__P) && (i2 = [], (r2 = h({}, o2)).__v = o2.__v + 1, L$1(c2, o2, r2, u2.__n, void 0 !== c2.ownerSVGElement, null != o2.__h ? [e2] : null, i2, null == e2 ? b$1(o2) : e2, o2.__h), M(i2, o2), o2.__e != e2 && g$2(o2)), t.length > l2 && t.sort(f$1));
  w$2.__r = 0;
}
...
function A(n2, l2, u2) {
  for (var i2, t2 = n2.__k, r2 = 0; t2 && r2 < t2.length; r2++)
    (i2 = t2[r2]) && (i2.__ = n2, l2 = "function" == typeof i2.type ? A(i2, l2, u2) : C$1(u2, i2, i2, t2, i2.__e, l2));
  return l2;
}
function P$1(n2, l2) {
...
function H$1(n2, l2, u2, i2, t2) {
  var r2;
  for (r2 in u2)
    "children" === r2 || "key" === r2 || r2 in l2 || T$1(n2, r2, null, u2[r2], i2);
  for (r2 in l2)
    t2 && "function" != typeof l2[r2] || "children" === r2 || "key" === r2 || "value" === r2 || "checked" === r2 || u2[r2] === l2[r2] || T$1(n2, r2, l2[r2], u2[r2], i2);
}
...
function T$1(n2, l2, u2, i2, t2) {
  ...
  n:
    if ("style" === l2)
      ...
      r2 = l2 !== (l2 = l2.replace(/Capture$/, "")), l2 = l2.toLowerCase() in n2 ? l2.toLowerCase().slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? i2 || n2.addEventListener(l2, r2 ? z$1 : j$2, r2) : n2.removeEventListener(l2, r2 ? z$1 : j$2, r2);
...
function N(l2, u2, i2, t2, r2, o2, f2, e2) {
  ...
  if (null === d2)
    ...
    e2 || ("value" in p2 && void 0 !== (_2 = p2.value) && (_2 !== l2.value || "progress" === d2 && !_2 || "option" === d2 && _2 !== y2.value) && T$1(l2, "value", _2, y2.value, false), "checked" in p2 && void 0 !== (_2 = p2.checked) && _2 !== l2.checked && T$1(l2, "checked", _2, y2.checked, false));
  }
  return l2;
}
function O(n2, u2, i2) {
...
function B$1(u2, i2, t2) {
  var r2, o2, f2;
  l$1.__ && l$1.__(u2, i2), o2 = (r2 = "function" == typeof t2) ? null : t2 && t2.__k || i2.__k, f2 = [], L$1(i2, u2 = (!r2 && t2 || i2).__k = y(_, null, [u2]), o2 || c$1, c$1, void 0 !== i2.ownerSVGElement, !r2 && t2 ? [t2] : o2 ? null : i2.firstChild ? n.call(i2.childNodes) : null, f2, !r2 && t2 ? t2 : o2 ? o2.__e : i2.firstChild, r2), M(f2, u2);
}
function F$1(n2, l2) {
...
n = s.slice, l$1 = { __e: function(n2, l2, u2, i2) {
  ...
  var u2;
  u2 = null != this.__s && this.__s !== this.state ? this.__s : this.__s = h({}, this.state), "function" == typeof n2 && (n2 = n2(h({}, u2), this.props)), n2 && h(u2, n2), null != n2 && this.__v && (l2 && this._sb.push(l2), m$1(this));
}, k$1.prototype.forceUpdate = function(n2) {
  this.__v && (this.__e = true, n2 && this.__h.push(n2), m$1(this));
}, k$1.prototype.render = _, t = [], o = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, f$1 = function(n2, l2) {
...
(w.prototype = new k$1()).isPureReactComponent = true, w.prototype.shouldComponentUpdate = function(n2, t2) {
...
}, (D.prototype = new k$1()).__c = function(n2, t2) {
...
function j(n2) {
  ...
  e2.componentWillUnmount = function() {
    B$1(null, e2.l), e2.l = null, e2.i = null;
  ...
  } }), B$1(y(P, { context: e2.context }, n2.__v), e2.l)) : e2.l && e2.componentWillUnmount();
}
function z(n2, e2) {
  var r2 = y(j, { __v: n2, i: e2 });
  return r2.containerInfo = e2, r2;
}
(V.prototype = new k$1()).__a = function(n2) {
...
k$1.prototype.isReactComponent = {}, ["componentWillMount", "componentWillReceiveProps", "componentWillUpdate"].forEach(function(t2) {
  Object.defineProperty(k$1.prototype, t2, { configurable: true, get: function() {
...
function flushSync$1(runBeforeFlush) {
  ...
  B$1(y(FakeComponent, {}), document.createElement("div"));
...
function createContext$1(defaultValue) {
  var ContextType = F$1(defaultValue);
