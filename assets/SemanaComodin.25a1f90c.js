...
const usePlanSemanaComodin = defineStore("planSemanaComodin", () => {
  ...
  function obtenerSesion(semanaindex, diaindex) {
    return __spreadValues({}, semanaComodin.value[semanaindex][diaindex]);
  }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const agregarSesion = (rutina) => {
      ...
      semanaComodinStore.adicionarSesion(rutina, posicionPlan.indexsemana, posicionPlan.indexdia);
    };
    ...
    const crearSemanaComodin = handleSubmit(() => {
      semanaComodinStore.guardarPlan(__spreadValues({}, plan.value));
      mostrarCofirmarOpciones.value.crear = false;
    });
    const actualizarPlan = () => {
      emits("actualizar-comodin");
      semanaComodinStore.actualizarPlan(__spreadValues({}, plan.value));
