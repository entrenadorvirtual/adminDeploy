import { y as defineComponent, z as ref, R as useDarkmode, X as useRouter, r as reactive, e as computed, a5 as useHead, p as resolveComponent, o as openBlock, i as createElementBlock, j as createBaseVNode, M as withKeys, D as unref, q as createVNode, w as withCtx, v as withModifiers, Z as createStaticVNode, m as createTextVNode, al as __unplugin_components_0, Y as _sfc_main$3 } from "./index.9a2a8c84.js";
import { _ as _sfc_main$2 } from "./VField.227f0b66.js";
import { _ as __unplugin_components_2 } from "./VControl.e65ff893.js";
import { _ as _sfc_main$1 } from "./VInput.22932c5c.js";
...
import { L as LOGIN_USER_PASSWD } from "./auth.e72f18a6.js";
...
const _hoisted_14 = /* @__PURE__ */ createBaseVNode("h2", null, "Bienvenido de vuelta", -1);
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("p", null, "Por favor ingresa tus datos para iniciar sesi\xF3n", -1);
const _hoisted_16 = /* @__PURE__ */ createTextVNode(" Todavia no tengo una cuenta ");
...
const _hoisted_21 = /* @__PURE__ */ createTextVNode(" Iniciar Sesi\xF3n ");
    ...
    const handleLogin = async () => {
      ...
      if (!isLoading.value) {
        ...
        if (uid) {
          ...
          if (datosUsuraio.datosUsuario.rol === "Entrenador") {
            router.push("/entrenador");
          } else if (datosUsuraio.datosUsuario.rol === "Admin") {
            router.push("/administrador");
          } else if (datosUsuraio.datosUsuario.rol === "Deportista" && datosUsuraio.datosUsuario.bienvenida === 0) {
            router.push("/deportista/rutinas");
          } else {
