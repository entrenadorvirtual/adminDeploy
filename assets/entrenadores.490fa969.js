import { _ as _sfc_main$9 } from "./VModal.3ed19e4b.js";
import { a as _sfc_main$8 } from "./VFlexTable.49c23410.js";
import { _ as _sfc_main$7 } from "./VTag.eba4e6e6.js";
import { _ as _sfc_main$6 } from "./VPlaceholderPage.fef3ca53.js";
import { y as defineComponent, z as ref, e as computed, C as watch, p as resolveComponent, o as openBlock, i as createElementBlock, j as createBaseVNode, q as createVNode, w as withCtx, Y as withDirectives, a1 as vModelText, D as unref, f as createBlock, l as createCommentVNode, F as Fragment, s as renderList, t as toDisplayString, m as createTextVNode, ap as TransitionGroup, al as _sfc_main$4, O as _sfc_main$5, A as onMounted, V as _export_sfc, P as useHead } from "./index.81c578a3.js";
import { a as __unplugin_components_2, b as _sfc_main$3 } from "./VControl.0351758b.js";
import { _ as _imports_0, a as _imports_1, u as utils, w as writeFileSync } from "./xlsx.310b38c1.js";
...
const _hoisted_18 = /* @__PURE__ */ createBaseVNode("div", { class: "table-cell-header" }, [
  /* @__PURE__ */ createBaseVNode("strong", null, "CEDLULAR")
], -1);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const filteredData = computed(() => {
      if (!filters.value && !fechaInicial.value && !fechaFinal.value) {
        return props.entrenadores;
      }
      const filterRe = new RegExp(filters.value, "i");
      const filteredByKeyword = props.entrenadores.filter((item) => {
        return item.UserID.toString().match(filterRe) || item.identificacion.toString().match(filterRe) || item.nombres.match(filterRe) || item.apellidos.toString().match(filterRe) || item.nameUser.toString().match(filterRe) || item.fecha_nacimiento.toString().match(filterRe) || item.telefono.toString().match(filterRe) || item.fecha_registro.toString().match(filterRe) || item.estado.toString().match(filterRe);
      });
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  setup(__props) {
    ...
    function fechaReg(fechaISO) {
      ...
      return fecha.toLocaleDateString(void 0, options) != "Invalid Date" ? fecha.toLocaleDateString(void 0, options) : "No Registra ";
    }
    return (_ctx, _cache) => {
